...
<?php foreach( $tables as $table ) : ?>
	<option value="<?php echo site_url('tasks') . '?table=' . $table; ?>"<?php echo ( isset( $_GET['table'] ) && $_GET['table'] == $table ) ? ' selected="selected"' : ""; ?>><?php echo $table ?></option>}
<?php endforeach; ?></select>
</div>
<div id="header_right">

<?php echo anchor('tasks'.$table_url, $this->lang->line('scaff_view_records')); ?> &nbsp;&nbsp;|&nbsp;&nbsp;
